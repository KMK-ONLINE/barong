  ...
  _createClass(Page, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_content.Content, { data: this.props.data }),
...
window.render = function (data) {
  _reactDom2.default.render(_react2.default.createElement(Page, { data: data }), document.getElementById('page'));
  document.getElementById('key').focus();
  console.log(document.getElementById('key'));
};

},{"./components/content.js":161,"./components/footer.js":163,"./components/header.js":164,"react":158,"react-dom":2}],161:[function(require,module,exports){
"use strict";
...
var _thumbnails = require("./thumbnails.js");
...
var Content = exports.Content = (function (_React$Component) {
  ...
  _createClass(Content, [{
    key: "updateDataItem",
    value: function updateDataItem(index, newData) {
    ...
    value: function setActiveItemIndex(activeItemIndex) {
      this.setState({
    ...
    value: function render() {
      ...
      if (this.state.activeItemIndex > -1) {
        detail = _react2.default.createElement(_detail.Detail, { item: this.state.data[this.state.activeItemIndex] });
      }
      return _react2.default.createElement(
        "div",
        { className: "content" },
        _react2.default.createElement(_thumbnails.Thumbnails, {
...
},{"./detail.js":162,"./thumbnails.js":166,"react":158}],162:[function(require,module,exports){
"use strict";
...
var Detail = exports.Detail = (function (_React$Component) {
  ...
  _createClass(Detail, [{
    key: "image",
    value: function image(src, key) {
      return _react2.default.createElement(
        "a",
        { href: "javascript:", key: key, className: "detail__link" },
        _react2.default.createElement("img", { className: "detail__image", src: src })
      );
    }
  }, {
    key: "title",
    ...
    value: function diff() {
      if (this.props.item) {
        return _react2.default.createElement(
          "span",
          { className: "detail__diff" },
          "Diff percentage: ",
          _react2.default.createElement(
            "strong",
            { className: "detail__diff-value" },
            this.props.item.report,
            "%"
          )
        );
      }
    ...
    value: function getDetails(item) {
      ...
      return [this.image(item.ref, 0), this.image(item.test, 1), this.image(item.diff, 2)];
    }
  }, {
    key: "render",
    value: function render() {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          "  — Visual Regression Testing Tools. It help us see things that cannot be seen with our mortal eyes."
        )
      );
    }
  }]);
...
exports.ThumbnailsItem = undefined;
...
var ThumbnailsItem = exports.ThumbnailsItem = (function (_React$Component) {
  ...
  _createClass(ThumbnailsItem, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _resemblejs2.default)(this.props.data.test).compareTo(this.props.data.ref).ignoreColors().onComplete((function (data) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "a",
        { href: "javascript:;", onClick: this.setActive.bind(this), className: itemClassName },
        _react2.default.createElement("img", { className: "thumbnails__image", src: this.props.data.test })
      );
    }
  }]);
...
},{"react":158,"resemblejs":159}],166:[function(require,module,exports){
"use strict";
...
var _thumbnailsItem = require("./thumbnails-item.js");
...
var Thumbnails = exports.Thumbnails = (function (_React$Component) {
  ...
  _createClass(Thumbnails, [{
    ...
    value: function onKeyUp(e) {
      var index = this.props.activeItemIndex;
    ...
    value: function render() {
      var items = this.props.data.map((function (itemData, index) {
        return _react2.default.createElement(_thumbnailsItem.ThumbnailsItem, {
          index: index,
          key: index,
          data: itemData,
      ...
      return _react2.default.createElement(
        "div",
        { className: "thumbnails", onKeyUp: this.onKeyUp.bind(this) },
        items,
...
},{"./thumbnails-item.js":165,"react":158}]},{},[160]);
